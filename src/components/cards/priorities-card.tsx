...
import PrioritiesModal from "@/components/modals/priorities-modal";
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {priorities.length === 0 ? (
                            ...
                            priorities.slice(0, 8).map((priority) => (
                                <div key={priority.id} className="flex items-center justify-between py-2 px-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                    ...
                    {priorities.length > 8 && (
                        <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                            <div className="text-xs text-gray-500 dark:text-gray-400 text-center">
                                +{priorities.length - 8} more priorities
                            </div>
                        </div>
                    )}
                </CardContent>

      ...
      <Card className="bg-white dark:bg-gray-800 shadow-md border-none min-w-[300px]">
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Sites</CardTitle>
            <button
        ...
        <CardContent className="pt-0">
          ...
          {sites.length > 8 && (
            <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
              <div className="text-xs text-gray-500 dark:text-gray-400 text-center">+{sites.length - 8} more sites</div>
            </div>
          )}
        </CardContent>
      </Card>

      <SiteModal isOpen={isModalOpen} onOpenChange={setIsModalOpen} onSitesChange={handleSitesChange} />
    </>
  );
}

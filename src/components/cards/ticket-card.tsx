    ...
    <>
      ...
      >
        <CardHeader className="text-xl font-semibold text-gray-800 dark:text-gray-200 flex-row items-start justify-between">
          ...
          <Badge
            className={`ml-2 ${getStatusColor(ticket.status)} text-nowrap inline-block min-w-fit`}
            style={{ textWrap: "nowrap", minWidth: "fit-content" }}
            variant="secondary"
          >
          ...
          <TooltipProvider>
            <Tooltip delayDuration={100}>
              <TooltipTrigger asChild>
                <div>
                  <PersonEntityAvatar name={assignee?.name} type="assignee" className="cursor-pointer" />
                </div>
              </TooltipTrigger>
            ...
            <Tooltip delayDuration={100}>
              ...
              <TooltipContent className="bg-gray-800 text-gray-100 *:text-sm">High Priority</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </CardFooter>
      </Card>

...
export const IconlyArrowRight2 = ({ size = 24, color = "#000000" }: IconlyIconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Iconly/Bold/Arrow---Right-2" stroke="none" strokeWidth="1.5" fill="none" fillRule="evenodd">
                <g id="Arrow---Right-2" transform="translate(7.000000, 6.000000)" fill={color} fillRule="nonzero">

...
|----|---------|----------|-----------|--------|-----|--------|
| [AUDIT-1](audit-1-foundation.md) | Foundation — capture Ticket changes, view on admin-only `/audit` | **HITL** | — | backend, database, frontend, security | 8 | In progress |
| [AUDIT-2](audit-2-broaden-capture.md) | Extend capture to all business tables + cascade txid grouping | AFK | AUDIT-1 | backend, database, frontend | 5 | Todo |
